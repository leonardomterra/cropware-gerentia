 ...
 * (slate-900/800/700 = farm-primary darkest/darker/dark). No mobile o painel
...
export function AuthLayout({ title, subtitle, children }: AuthLayoutProps) {
  return (
    <main className="min-h-screen w-full flex items-stretch bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col items-center justify-center gap-5 border-r border-slate-200 bg-gradient-to-br from-white via-slate-50 to-slate-100 p-12">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-[380px] space-y-6">
          ...
          <div className="lg:hidden flex flex-col items-center gap-2 mb-2">
            ...
            <LogoWordmark className="[--logo-color:#525252] [--logo-size:22px]" />
          </div>
          ...
          {(title || subtitle) && (
            <div className="space-y-1">
              ...
              {subtitle && (
                <p style={{ fontSize: "14px", color: "#a3a3a3" }}>{subtitle}</p>
              )}
            </div>
          )}

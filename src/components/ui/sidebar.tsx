...
function Sidebar({
  ...
  const appTopOffset = "var(--app-top-offset, 0px)";
  const desktopCollapsedWidth =
      ...
      <div
        ...
        className={cn(
          desktopMode === "fixed"
            ...
            : "sticky top-0 z-10 hidden h-svh w-(--sidebar-width) self-start overflow-hidden transition-[width] duration-200 ease-linear md:flex",
          desktopMode === "fixed" &&
            (side === "left"
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "m-0 w-full min-w-0 list-none translate-x-0 border-l-0 p-0 flex flex-col gap-0",
        "group-data-[collapsible=icon]:hidden",
        className,
      )}
      {...props}
...
function SidebarMenuSubItem({
  ...
  return (
    <li
      ...
      className={cn("group/menu-sub-item relative block w-full", className)}
      {...props}
    />
  );
}
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground [&>svg]:text-sidebar-accent-foreground flex h-8 w-full min-w-0 translate-x-0 items-center gap-2 overflow-hidden rounded-md px-2 outline-hidden focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",

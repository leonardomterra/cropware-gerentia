    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          ...
          disabled={disabled}
          className={cn(
            "h-9 w-full inline-flex items-center justify-between gap-2 rounded border border-slate-200 bg-white px-3 text-base md:text-sm text-slate-900 transition-colors hover:border-slate-200 disabled:opacity-50 disabled:cursor-not-allowed",

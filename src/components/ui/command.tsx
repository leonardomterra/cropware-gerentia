...
function CommandInput({
  ...
  return (
    <div
      ...
      className="flex h-9 items-center gap-2 border-b border-slate-100 px-3"
    >
...
function CommandList({
  ...
  return (
    <CommandPrimitive.List
      ...
      style={{
        maxHeight:
          "min(300px, var(--radix-popover-content-available-height, var(--radix-select-content-available-height, var(--radix-dropdown-menu-content-available-height, var(--radix-popper-available-height, 300px)))))",
        ...style,
      }}
      {...props}
    />

...
/**
 * CRUD de farm_tasks — modulo Pendencias/To-Do.
 *
 * Tarefas PESSOAIS: todo usuario da org cria/edita as suas (requireFarmUser,
 * NAO admin — diferente de recurring). A lista filtra por created_by ("minhas
 * tarefas") e as escritas tambem exigem created_by; a RLS mantem o escopo por
 * organizacao. due_date opcional; priority in low|normal|high.
 */
...
export function mountTaskRoutes(app: Hono) {
  ...
  app.patch("/tasks/:id", async (c) => {
    try {
      ...
      const ALLOWED = ["title", "notes", "due_date", "done", "priority"];

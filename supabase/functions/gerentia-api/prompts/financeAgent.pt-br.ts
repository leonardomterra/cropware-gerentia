...
export function buildFinanceAgentPrompt(ctx: PromptCtx): string {
  ...
  return [
    ...
    "- Data: SÓ preencha transaction_date se for ESPECÍFICA ('ontem', 'anteontem', 'dia 25', '25/03', 'terça passada'). Se não citar, ou for VAGA ('semana passada', 'mês passado', 'esses dias'), deixe VAZIO (o app pergunta a data).",
